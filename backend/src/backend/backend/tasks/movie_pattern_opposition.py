...
@PluginManager.export_parser("movie_pattern_opposition")
class MoviePatternOppositionParser(Parser):
    def __init__(self):
...
@PluginManager.export_plugin("movie_pattern_opposition")
class MoviePatternOpposition(Task):
    def __init__(self):
        self.config = {
    ...
    def __call__(
        ...
        **kwargs,
        ...
        movie_pattern_opposition = self.run_analyser(
            client,
            "movie_pattern_opposition",
            inputs={
                "faces": face_size_filter_result[0]["faces"],
            ...
            downloads=["opposition"],
        )
        if movie_pattern_opposition is None:
            raise Exception
        ...
        with transaction.atomic():
            with movie_pattern_opposition[1]["opposition"] as data:
                ...
                return {
                    ...
                    "data": {
                        "annotations": movie_pattern_opposition[1]["opposition"].id
                    },
                }
