...
@PluginManager.export_parser("movie_pattern_shot_reverse_shot")
class MoviePatternShotReverseShotParser(Parser):
    def __init__(self):
...
@PluginManager.export_plugin("movie_pattern_shot_reverse_shot")
class MoviePatternShotReverseShot(Task):
    def __init__(self):
        self.config = {
    ...
    def __call__(
        ...
        **kwargs,
        ...
        movie_pattern_shot_reverse_shot = self.run_analyser(
            client,
            "movie_pattern_shot_reverse_shot",
            inputs={
                "faces": face_size_filter_result[0]["faces"],
            ...
            downloads=["shot_reverse_shot"],
        )
        if movie_pattern_shot_reverse_shot is None:
            raise Exception
        ...
        with transaction.atomic():
            with movie_pattern_shot_reverse_shot[1]["shot_reverse_shot"] as data:
                ...
                category_db, _ = AnnotationCategory.objects.get_or_create(
                    name="Shot Reverse Shot", video=video, owner=user
                )
                ...
                return {
                    ...
                    "data": {
                        "annotations": movie_pattern_shot_reverse_shot[1][
                            "shot_reverse_shot"
                        ].id
                    },
                }
