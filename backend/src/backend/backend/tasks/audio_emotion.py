...
@PluginManager.export_parser("audio_emotion")
class AudioEmotionParser(Parser):
    def __init__(self):
        self.valid_parameter = {
            "timeline": {"parser": str, "default": "Audio Emotion Classification"},
        }


@PluginManager.export_plugin("audio_emotion")
class AudioEmotion(Task):
    def __init__(self):
        self.config = {
        ...
        **kwargs,
        ...
        def create_timelines(
            ...
            for emotion, idx in emotions.items():
                ...
                result_timelines[emotion] = timeline.id.hex
        ...
        with transaction.atomic():
            with result[1]["annotations"] as ann_data:
                emotions = {"neutral": 0, "angry": 1, "happy": 2, "sad": 3}
