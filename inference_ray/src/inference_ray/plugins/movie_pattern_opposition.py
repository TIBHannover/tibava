...
@AnalyserPluginManager.export("movie_pattern_opposition")
class MoviePatternOpposition(
    AnalyserPlugin,
    ...
    def call(
        ...
        with (
            ...
            data_manager.create_data("AnnotationData") as opposition,
        ):
            faces = {}
            ...
            for shot in srso_list:
                ...
                opposition.annotations.append(
                    Annotation(start=start, end=end, labels=["Opposition"])
                )
